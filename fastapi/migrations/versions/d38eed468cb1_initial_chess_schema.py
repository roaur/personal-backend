...
def upgrade() -> None:
    ...
    sa.Column('lichess_game_id', sa.String(length=255), nullable=False),
    ...
    sa.PrimaryKeyConstraint('lichess_game_id'),
    schema='chess'
    )
    ...
    sa.ForeignKeyConstraint(['lichess_game_id'], ['chess.games.lichess_game_id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='chess'
    )
    ...
    sa.PrimaryKeyConstraint('lichess_game_id', 'player_id'),
    schema='chess'
    )
